Vue.component('app-bookCon', {
    template:
    `
    <section class="absolute top-0 left-0 w-full h-full bg-black/30 z-50" id="pageCon">
        <article class="relative w-full h-full" @click.prevent="closeComp">
            <div class="absolute top-2/10 w-8/10 xl:w-7/10 2xl:w-6/10 4xl:w-5/10 5xl:w-2/5 left-1.5/10 2xl:left-2/10 4xl:left-2.5/10 5xl:left-3/10" @click.prevent.stop>
